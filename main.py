# main.py - NaijaBuzz FINAL 100% CLEAN (2025) - NO BBN/CRYPTO TEXT + REAL NEWS + IMAGES + TIME
...
<meta name="description" content="Fresh Naija news, football, gossip, entertainment, tech, viral — updated every 5 mins!">
...
<style>
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .tagline{font-size:1.1rem;color:#888;margin-top:0.5rem;}
    ...
    .nav a{padding:12px 20px;background:var(--bg);color:var(--text);border-radius:50px;font-weight:700;text-decoration:none;transition:0.3s;}
...
<header>
  <h1>NaijaBuzz</h1>
  <div class="tagline">Latest Naija News • Football • Gossip • Entertainment • Updated LIVE</div>
</header>
